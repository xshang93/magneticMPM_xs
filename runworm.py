...
robotFile = "worm_test/worm_test.yaml"
print("Generating Particles....")
r = Robot(robotFile, ppm3=1e12, scale=1e-3)

# Simulation Parameters
grid_size = 50e-3 # Width and Height of window in metres
...
field = np.array([0, 0 ,1]) # field is useless?
t = 0
p_size = 0.10
magnitude = 200 # unit??
theta = np.pi
angle = 0
rotate = True
frq = 10 # This is the frequency of mag field rotation
...
while window.running:
    ...
    if timesteps % renderEvery == 0:
        ...
        if rotate:
            ...
            magnitude = (t % (1/frq)*frq)*magnitude
            theta = np.pi + alpha
